...
public class CalculadoraOO {
	public CalculadoraOO(TecladoImpl teclado, Tela2 tela){
		this.tela = tela;
		this.teclado = teclado;
	}

	private TelaImpl tela;
	private TecladoImpl teclado;
	...
	public static void main(String[] args) throws IOException {
		CalculadoraOO cal1 = new CalculadoraOO(new TecladoImpl(), new Tela2());
